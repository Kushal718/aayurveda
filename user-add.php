...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title -->
            <form action="user-save.php" method="POST" class="needs-validation"  id="useradd-form" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <div class="row gy-4">
                                        <input type="hidden" class="form-control" name="mess_id" value="<?php echo $mess_profile['mess_id']; ?>" required>
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                          ...
                                          <div class="col-xxl-3 col-md-4">
                                            <div>
                                                ...
                                                <input type="file" accept=".png, .jpg, .jpeg" class="form-control"  name="emp_photo" required>
                                            </div>
                                        </div>
<!--                                            <div class="col-xxl-3 col-md-4">
                                            <div>       <br>  <br>                                       
                                                <input  type="checkbox" name="other" >
 <label for="placeholderInput" class="form-label">Show on WebSite</label>
                                            </div>
                                        </div>-->
