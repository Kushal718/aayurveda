...
FROM feedback where is_verified='0' ORDER  BY feedback_id DESC");
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                               ...
                                               <td>
                                                    ...
                                                    <div class="edit">                                                            
                                                            <a class="btn btn-sm btn-success edit-item-btn" href='feedback-verify.php?id=<?php echo $f['feedback_id']; ?>' ;><i class=" ri-check-line"></i></a>
                                                        </div>
