...
<footer class="site-footer">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="footer-widget__column footer-widget__about">
                        <div class="footer-widget__logo">
                            <a href="index.html"><img src="assets/images/resources/logo-12.png" alt=""></a>
                        </div>
                    ...
                    <div class="footer-widget__column footer-widget__Contact">
                        ...
                        <ul class="footer-widget__Contact-list list-unstyled">
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="mailto:needhelp@company.com">codeved@gmail.com</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p><a href="tel:926668880000">9999999999</a></p>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="site-footer__bottom">
        <marquee width="100%" direction="right"><img height="80px"  src="ambulance.gif"></marquee>
       
        <div class="site-footer__bottom-shape"
             style="background-image: url(assets/images/shapes/site-footer-bottom-shape.png);">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        ...
                        <p class="site-footer__bottom-text">© Copyright 2023 by <a href="#">Team CodeVed</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from bracketweb.com/gardon-html/main-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Sep 2023 08:10:58 GMT -->
</html>