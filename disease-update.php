...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Update Disease</h4>
            ...
            <!-- end page title -->
            <form action="disease-update-save.php" method="POST" class="needs-validation" id="userupdate-form"
                enctype="multipart/form-data">
                <input type="hidden" class="form-control" id="diseaseName" name="disease_id"
                                       value="<?php echo $disease['disease_id']; ?>" required>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                    ...
                                    <div class="row gy-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="diseaseName" name="disease_name"
                                                value="<?php echo $disease['disease_name']; ?>"required>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-xxl-12 col-md-12">
                                            ...
                                            <label for="" class="form-label">Description</label>
                                                <textarea name="description" id="description" value=""cols="150" rows="10"><?php echo $disease['description']; ?></textarea>
                                            <!-- <div class="card-body">
                        <div class="news-editor" style="height: 300px;"></div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="do_s[]"  id="tags-input" data-role="tagsinput"  value="<?php echo $disease['do_s']; ?>"
                                                   class="form-control"   >
                                        </div>

                                        <div class="mb-3">
                                            <label for="do_s" class="form-label">Don't</label>
                                            <input type="text" name="don_t[]"  id="tags-input" data-role="tagsinput"  value="<?php echo $disease['don_t']; ?>"
                                                   class="form-control"   >
                                        </div>
...
<script>
    ...
    function getNews() {
        // Get the Quill editor's content as HTML
        var editorContent = quill.root.innerHTML;

        // Update the hidden input field's value with the content
        document.getElementById('news').value = editorContent;
    }
    </script>
